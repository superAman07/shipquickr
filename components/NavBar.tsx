          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="md:hidden flex items-center gap-3">
              ...
              <div className="relative" ref={mobileMenuRef}>
                ...
                <div
                  className={`absolute right-0 mt-1 w-56 bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden transition-all duration-300 ease-out transform origin-top-right ${
                    isMobileMenuOpen
                      ? "opacity-100 scale-100 translate-y-0"
                      : "opacity-0 scale-95 -translate-y-2 pointer-events-none"
                  }`}
                >
                  {/* Only Recharge and future additions */}
                  <div className="py-2">
                    {userRole !== "admin" && (
                      <button
                        onClick={handleRechargeClick}
...
// import { Sun, Moon, Wallet, ChevronDown, User, Lock, LogOut, BatteryPlus } from 'lucide-react';
...
//                   <button onClick={handleRechargeClick} className="md:flex items-center cursor-pointer space-x-1 px-4 py-2 rounded-md bg-[#0a0c37] text-white font-semibold text-sm hover:bg-[#0a0c37e1] transition ">
//                     <BatteryPlus />
//                     <span className="pl-1">Recharge</span>
//                   </button>
//                   </div>
