...
// Make sure DayPicker types are imported if needed, v9 might have different type exports
import { DayPicker, type DayPickerProps } from "react-day-picker"

import { cn } from "@/lib/utils"
import { buttonVariants } from "@/components/ui/button"

export type CalendarProps = DayPickerProps // Use DayPickerProps directly from v9
...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      classNames={{ // These classNames style the default v9 buttons/icons
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100" // Styles the button containing the icon
        ),
