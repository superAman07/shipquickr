            ...
            <CardContent className="p-8">
              <div className="space-y-6">
                <div>
                  ...
                  <div className="border border-gray-300 dark:border-gray-600 rounded-t-md bg-gray-50 dark:bg-gray-700 p-2">
                  ...
                  <Textarea
                    ...
                    className="min-h-64 border-t-0 rounded-t-none resize-none focus:ring-0 focus:ring-offset-0 dark:bg-gray-800 dark:text-gray-100"
                  />
                </div>
                ...
                <div className="flex justify-center space-x-4 pt-4">
                  <Button 
                    ...
                    className="px-8 py-2 bg-red-500 hover:bg-red-600 text-white"
                  >
                    CANCEL
                  </Button>
                  <Button 
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="bg-slate-800 text-white px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <nav className="flex items-center space-x-2 text-sm">
            <span className="hover:text-blue-300 transition-colors cursor-pointer flex items-center">
              <Home className="h-3 w-3 mr-1" />
              Dashboard
            </span>
            <span className="text-gray-400">›</span>
      ...
      <div className="p-6">
        <Card className="dark:bg-gray-800 dark:border-gray-700">
          <CardHeader className="flex flex-row items-center justify-between">
            <CardTitle className="text-xl font-medium text-gray-800 dark:text-gray-200">News</CardTitle>
            <Button 
