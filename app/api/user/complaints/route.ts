...
async function saveFile(file: File | null, folder: string): Promise<string | null> {
    ...
    const allowedTypes = ["application/pdf", "audio/mpeg", "audio/wav", "audio/ogg", "image/jpeg", "image/png"];
    ...
    if (!isAllowedType) {
        ...
        throw new Error(`Invalid file type. Only PDF, Audio, or Images (JPG/PNG) allowed.`);
    }
