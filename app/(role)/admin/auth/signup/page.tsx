      ...
      <div className="absolute w-[250px] sm:w-[300px] md:w-[400px] h-[250px] sm:h-[300px] md:h-[400px] rounded-full bg-indigo-500/20 right-0 bottom-0 animate-pulse delay-700"></div>
        ...
        <div className="w-full max-w-4xl flex flex-col md:flex-row rounded-l-2xl overflow-x-visible shadow-2xl backdrop-blur-sm bg-white/5">
          <div className="w-full md:w-5/12 backdrop-blur-3xl p-6 rounded-l-2xl sm:p-8 text-white relative overflow-x-visible">
            <div className="col-lg-5 col-md-5 col-12 auth-left-side d-flex justify-center center">
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-6 md:mb-10 mt-2 md:mt-4">
                Manage Your Platform with Admin Access
              </h2>
              ...
              <div className="space-y-6 md:space-y-8">
                <div className="flex items-start gap-3 md:gap-4">
                  ...
                  <div>
                    <h3 className="text-lg sm:text-xl font-bold">Platform Control</h3>
                    <p className="text-blue-100 text-sm sm:text-base">Manage settings, users, and overall operations.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 md:gap-4">
                  ...
                  <div>
                    <h3 className="text-lg sm:text-xl font-bold">Request Oversight</h3>
                    <p className="text-blue-100 text-sm sm:text-base">Review and approve verifications and transactions.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 md:gap-4">
                  ...
                  <div>
                    <h3 className="text-lg sm:text-xl font-bold">Data Insights</h3>
                    <p className="text-blue-100 text-sm sm:text-base">Access analytics to optimize performance.</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="w-full md:w-7/12 rounded-r-2xl bg-white p-6 sm:p-8">
            ...
            <h2 className="text-xl sm:text-2xl font-semibold text-center text-gray-800 mb-6 sm:mb-8">Admin Sign Up</h2>
